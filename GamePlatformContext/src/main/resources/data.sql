...
values ('7a0ff880-adf8-4b6c-821f-607f3d6d5895', 'Game', 'The best game', 10, 'USD', 2, 'http://localhost:5173', 'http://localhost:8081', 'http://localhost:9090/image'),
       ('203028d1-4ce6-426e-9b4b-de9ec03f12be', 'Checkers', 'Normal checkers game', 5.99, 'EUR', 2, 'http://localhost:5173', 'http://localhost:8081', 'http://localhost:9090/image');
